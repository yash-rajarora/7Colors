...
!(function (t, e) {
  ...
  function ja(t, e) {
    ...
    return (
      (t = parseFloat(t)), "+" === r ? t + i : "-" === r ? t - i : "*" === r ? t * i : t / i
    );
  }
  function ka(t, e) {
  ...
  function fb(h, e) {
    ...
    return (
      !r &&
        v(h) &&
        ((l = r = h.radius || N),
        h.values ? ((h = Ot(h.values)), (f = !t(h[0])) && (l *= l)) : (h = eb(h.increment))),
      Va(
        e,
        r
          ? s(h)
            ...
            : function (e) {
                for (
                  ...
                  (r = f ? (r = h[u].x - n) * r + (i = h[u].y - a) * i : Math.abs(h[u] - n)) <
                    s && ((s = r), (o = u));
  ...
  function Db(t) {
    ...
    if (((At.lastIndex = 0), At.test(r)))
      return (e = Dt.test(r)), (t[1] = Ab(t[1], e)), (t[0] = Ab(t[0], e, zb(t[1]))), !0;
  }
  function Mb(t) {
    var e = (t + "").split("("),
      r = Et[e[0]];
    ...
    return (
      ga(t, function (t) {
        for (var e in ((Et[t] = ot[t] = a), (Et[(n = t.toLowerCase())] = r), a))
          Et[n + ("easeIn" === e ? ".in" : "easeOut" === e ? ".out" : ".inOut")] = Et[
            t + "." + e
          ] = a[e];
      }),
      a
  ...
  var Xt,
    ...
    Vt =
      ...
      (Xt.time = function time(t, e) {
        return arguments.length
          ? this.totalTime(
              Math.min(this.totalDuration(), t + Da(this)) % (this._dur + this._rDelay) ||
                (t ? this._dur : 0),
              e,
            )
          : this._time;
      ...
      (Xt.progress = function progress(t, e) {
        return arguments.length
          ? this.totalTime(
              this.duration() * (!this._yoyo || 1 & this.iteration() ? t : 1 - t) + Da(this),
              e,
            )
          : this.duration()
    ...
    return (
      ...
      (e.remove = function remove(t) {
        return r(t)
          ...
          : s(t)
          ? this.killTweensOf(t)
          : (xa(this, t), t === this._recent && (this._recent = this._last), za(this));
      }),
  ...
  function $b(t, e, i, n, a, o) {
    ...
    if (
      ...
      ((i._pt = h = new me(i._pt, a, t, 0, 1, u.render, u, 0, u.priority)), i !== c)
    )
    ...
    jt = function _initTween(t, e) {
      ...
      if (
        ...
        if (
          ...
          (r = ta(_, lt)),
          S &&
            (e < 0 && M && v && !P ? S.render(-1, !0) : S.revert(M && C ? ht : ut),
            (S._lazy = 0)),
          g)
        ) {
          if (
        ...
        for (t._pt = t._ptCache = 0, y = (C && w(y)) || (y && !C), i = 0; i < A.length; i++) {
          if (
            ...
            h &&
              ...
              ((t._pt = a = new me(t._pt, s, l.name, 0, 1, l.render, l, 0, l.priority)),
            ...
            for (n in r)
              dt[n] && (l = $b(n, r, t, c, s, z))
                ? l.priority && (o = 1)
                : (f[n] = a = qt.call(t, s, n, "get", r[n], c, z, 0, _.stringFilter));
          t._op && t._op[i] && t.kill(s, t._op[i]),
            R &&
              t._pt &&
              ((Ut = t), B.killTweensOf(s, f, t.globalTime(e)), (p = !t.parent), (Ut = 0)),
            t._pt && y && (ct[u.id] = 1);
        }
  ...
  var $t = (function (E) {
    function Tween(e, r, i, n) {
      ...
      if (
        ((a._targets = C.length
          ? da(C)
          : R("GSAP target " + e + " not found. https://greensock.com", !V.nullTargetWarn) ||
            []),
        (a._ptLookup = []),
        (a._overwrite = b),
        x || T || y(_) || y(m))
        ...
        if (
          ...
          ua(pa(s.vars.defaults, { ease: "none" })), (s._ease = Lt(x.ease || r.ease || "none"));
          var S,
            A,
            D,
            z = 0;
      ...
      return (
        !0 !== b || F || ((Ut = _assertThisInitialized(a)), B.killTweensOf(C), (Ut = 0)),
    ...
    return (
      (e.render = function render(t, e, r) {
        ...
        if (p) {
          if (
            ...
            if (((i = m), (l = this.timeline), this._repeat)) {
              ...
              a !== o &&
                ...
                !this.vars.repeatRefresh ||
                  u ||
                  this._lock ||
                  ((this._lock = r = 1), (this.render(ia(s * a), !0).invalidate()._lock = 0)));
            }
            if (!this._initted) {
            ...
            (l && l.render(t < 0 ? t : !i && u ? -q : l._dur * l._ease(i / this._dur), e, r)) ||
              (this._startAt && (this._zTime = t)),
              this._onUpdate && !e && (_ && Ba(this, t, 0, r), Pt(this, "onUpdate")),
              this._repeat &&
                a !== o &&
                this.vars.onRepeat &&
                !e &&
            ...
            if (
              ...
              e < 0 && Ba(t, e, 0, !0),
                ...
                (e >= t._tDur || e < 0) &&
                  ...
                  r ||
                    I ||
                    (Pt(t, u ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()));
      ...
      (e.resetTo = function resetTo(t, e, r, i) {
        ...
        return (
          ...
          (function _updatePropTweens(t, e, r, i, n, a, s) {
            ...
            : (Ha(this, 0),
              this.parent ||
                wa(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0),
              this.render(0))
        );
      }),
      (e.kill = function kill(t, e) {
        ...
        if (this.timeline) {
          ...
          return (
            this.timeline.killTweensOf(t, e, Ut && !0 !== Ut.vars.overwrite)._first || sb(this),
            this.parent &&
        ...
        for (
          ...
          if (~c.indexOf(f[l]))
            ...
            o))
              (h = a && a[u]) &&
                (("kill" in h.d && !0 !== h.d.kill(u)) || xa(this, h, "_pt"), delete a[u]),
                "all" !== s && (s[u] = 1);
          ...
          var e = (t = (!t.name && t.default) || t).name,
            ...
            i =
              e && !r && t.init
                ...
                : t,
            n = { init: T, render: ce, add: qt, kill: pe, modifier: de, rawVars: 0 },
            a = { targetTest: 0, get: 0, getSetter: ee, aliases: {}, register: 0 };
          if ((Rt(), t !== i)) {
            if (dt[e]) return;
            pa(i, pa(ta(t, n), a)),
  ...
  function Gd(t) {
    ...
    if (t in er) {
      if (
        ...
        return;
      r._gsap.svg && ((this.svgo = r.getAttribute("data-svg-origin")), this.props.push(lr, "")),
        (t = hr);
    }
      ...
      : ("px" === h || p || (u = Yd(t, e, r, "px")),
        ...
        (!_ && "%" !== h) || (!er[e] && !~e.indexOf("adius"))
          ? ((l[f ? "width" : "height"] = 100 + (p ? h : i)),
            ...
            (s = a._gsap) && _ && s.width && f && s.time === zt.time && !s.uncache
              ? ha((u / s.width) * 100)
              : ((!_ && "%" !== h) || pr[Md(a, "display")] || (l.position = Md(t, "position")),
  ...
  function $d(t, e, r, i) {
    ...
    if (
      ...
      (g.e = i),
      (r += ""),
      "auto" === (i += "") && ((t.style[e] = i), (i = Md(t, e) || i), (t.style[e] = r)),
      Db((s = [r, i])),
      (i = s[1]),
      (u = (r = s[0]).match(rt) || []),
      (i.match(rt) || []).length)
  ...
  function be(t, e) {
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      i &&
        (Ud(a, hr),
        u && (u.svg && a.removeAttribute("transform"), Tr(a, 1), (u.uncache = 1), Hd(s)));
    }
  }
  function fe(t) {
  ...
  function ue(t, e, r) {
    ...
    for (n in (l.svg
      ...
      : ((a = getComputedStyle(r)[hr]), (f[hr] = e), (i = Tr(r, 1)), (f[hr] = a)),
    er))
      (a = l[n]) !== (s = i[n]) &&
  ...
  var Se,
      ...
      return (
        ...
        er[e] && "transform" !== e
          ...
          : ((n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(")) ||
            (n =
              (gr[e] && gr[e](t, e, r)) || Md(t, e) || fa(t, e) || ("opacity" === e ? 1 : 0)),
    ...
    Tr = function _parseTransform(t, e) {
      ...
      return (
        ...
        r.svg &&
          ((k = r.uncache
            ? ((P = t.getBBox()), (X = r.xOrigin - P.x + "px " + (r.yOrigin - P.y) + "px"), "")
    ...
    Pr = function _renderSVGTransforms(t, e) {
      ...
      (c = parseFloat(c)),
        ...
        (v || y || T || b) &&
          ((x = ha(x + v - (v * r + y * n) + T)), (M = ha(M + y - (v * i + y * a) + b))),
        (u || h) &&
          ((s = g.getBBox()),
        ...
        e))
          if ("autoRound" !== c && ((o = e[c]), !dt[c] || !$b(c, e, i, n, t, a)))
            if (
              ...
              if (
                (M && c in M
                  ? ((s = "function" == typeof M[c] ? M[c].call(i, n, t, a) : M[c]),
                ...
                c in ur &&
                  ("autoAlpha" === c &&
                    (1 === h && "hidden" === _r(t, "visibility") && u && (h = 0),
              ...
              if (m || ((u || 0 === u) && (h || 0 === h) && !or.test(o) && c in x))
                (u = u || 0),
                  (d = (s + "").substr((h + "").length)) !==
                    (p = Xa(o) || (c in V.units ? V.units[c] : d)) && (h = Yd(t, c, s, p)),
                  (this._pt = new me(
                    this._pt,
                    m ? v : x,
                    c,
                    h,
                    (_ ? ja(h, _ + u) : u) - h,
                    m || ("px" !== p && "zIndex" !== c) || !1 === e.autoRound ? sd : vd,
                  )),
                  (this._pt.u = p || 0),
