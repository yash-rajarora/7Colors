(function e(t, n) {
    ...
    return function(e) {
                ...
                if (!this.preloadPromise || this.preloadPromise.route != t.url) {
                    s = new Promise(function(e, n) {
                        ...
                        if (!isExternalLink(t.url)) {
                            ...
                            window.open(t.url, '_blank'); // Open external links in a new tab
                            e(); // Resolve the promise as we don't want to halt execution
                        }
                    })
                } else {
        ...
        function isExternalLink(url) {
            return /^https?:\/\//.test(url) && !new RegExp(`^${window.location.origin}`).test(url);
        }
